        ...
        <main>
            ...
            <div class="boxed_wide">
                ...
                <div class="centered bottom_space">
                    <img class="image_logo" alt="logo_acteur" src=<?php echo $acteur_logo ?>>
                </div>
                <!-- Nom de l'acteur  -->
            ...
            <div class="boxed_wide">
                ...
                $sqlrequest = "SELECT post.post, post.acteur_id, post.user_id, post.date_add, account.account_id, account.first_name 
            FROM `post` INNER JOIN account ON post.user_id=account.account_id 
